...
2. In `app/build.gradle`, add the following dependencies:
    ...
    dependencies {
      ...
      compile 'com.github.tony19:logback-android:1.3.0-1'
    }
    ```
...
dependencies {
  compile 'org.slf4j:slf4j-api:1.7.25'
  compile 'com.github.tony19:logback-android:1.3.0-2-SNAPSHOT'
}
```
...
The file is output to: `./build/logback-android-1.3.0-1-debug.aar`
