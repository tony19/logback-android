...
The current version is **1.0.3-1**.

Download
--------
 * [logback-android-1.0.3-1.jar][13] (MD5: `fc93e08578ca9423422534add35a6bb7`)
...
3. Enter `ant` to begin the build. The JAR is created at `bin/logback-android-1.0.3-1.jar`.
 ...
 [13]: https://github.com/downloads/qos-ch/logback-android/logback-android-1.0.3-1.jar 
